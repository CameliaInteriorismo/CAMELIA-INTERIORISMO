...
/**
 * La cabecera de Proyectos. El título, la foto y su encuadre salen de
...
export function PageHeader({
  ...
  return (
    <PageHeroBanner
      ...
      image={imageProps(image)?.src ?? "/assets/proyectos/Proyectos hero.jpg"}
      titleClassName="text-background tracking-[0.02em]"
      imagePosition={imagePosition ?? "center 35%"}
    />
  );
}
